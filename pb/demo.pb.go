...
type StorNode struct {
	...
	// @gotags: pg:"-"
	NotMap2Orm bool `protobuf:"varint,9,opt,name=notMap2Orm,proto3" json:"notMap2Orm,omitempty" pg:"-"`
}
...
var file_demo_proto_rawDesc = []byte{
	...
	0x65, 0x6d, 0x70, 0x74, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x8a, 0x03, 0x0a, 0x08,
	...
	0x52, 0x0b, 0x62, 0x75, 0x79, 0x4e, 0x61, 0x6e, 0x6f, 0x54, 0x69, 0x6d, 0x65, 0x12, 0x3a, 0x0a,
	...
	0x70, 0x32, 0x4f, 0x72, 0x6d, 0x18, 0x09, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0a, 0x6e, 0x6f, 0x74,
...
var file_demo_proto_depIdxs = []int32{
	...
	5, // 1: ire.restgwdemo.v1.StorNode.updateTime:type_name -> google.protobuf.Timestamp
	0, // 2: ire.restgwdemo.v1.UpsertStorNodeRequest.storNode:type_name -> ire.restgwdemo.v1.StorNode
	0, // 3: ire.restgwdemo.v1.UpsertStorNodeResponse.storNode:type_name -> ire.restgwdemo.v1.StorNode
	5, // 4: ire.restgwdemo.v1.HealthzResponse.htime:type_name -> google.protobuf.Timestamp
	1, // 5: ire.restgwdemo.v1.Demo.UpsertStorNode:input_type -> ire.restgwdemo.v1.UpsertStorNodeRequest
	6, // 6: ire.restgwdemo.v1.Demo.Healthz:input_type -> google.protobuf.Empty
	6, // 7: ire.restgwdemo.v1.Demo.UpsertStorNode:output_type -> google.protobuf.Empty
	3, // 8: ire.restgwdemo.v1.Demo.Healthz:output_type -> ire.restgwdemo.v1.HealthzResponse
